...
require_once $_SERVER['DOCUMENT_ROOT'] . '/agent_order/api_integration/utils/PackageLoader.php';
 ...
 * Файл общего конфига
 */
$commonConfigJsPath = $_SERVER['DOCUMENT_ROOT'] . '/agent_order/api_integration/config/js/init.js';
