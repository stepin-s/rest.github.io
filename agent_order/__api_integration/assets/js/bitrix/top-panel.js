...
jQuery(document).ready(function($) {
    ...
    function animateShowHideTopPanel(_this) {
        function animateClose(_this) {
            _this.stop();
            _this.animate({'margin-top': "-"+ _this.height()}, 'slow', function() {
                _this.removeClass('opened');
                $.cookie('top-panel-closed', 1, {path: '/'});
            });
        }
        function animateShow(_this) {
            _this.stop();
            _this.animate({'margin-top': '0'}, 'slow', function() {
                _this.addClass('opened');
                $.cookie('top-panel-closed', 0, {path: '/'});
            });
        }
