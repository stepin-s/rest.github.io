...
abstract class CUriModule
{
    ...
    protected static $_iblock_settings = "/home/ih617957/public_html/include/curi/iblock_settings.ini";
    public static $urlRewritePath = "/urlrewrite.php";

    /*   * ************VARS************* */

    public static function parse_ini_file_quotes_safe($f)
    {
        $null = NULL;
        $r=$null;
        $sec=$null;
    ...
    protected function get_settings()
    {
        ...
        $ar_data = $this->parse_ini_file_quotes_safe($path);
    ...
    protected function get_iblock_settings()
    {
        $ar_data = self::parse_ini_file_quotes_safe(self::$_iblock_settings);
        if (!check_array($ar_data))
            return false;
