...
abstract class TaxiOrder
{
    ...
    {
        $templateParams = require $_SERVER['DOCUMENT_ROOT'] . DR . self:: MAIN_DIR . DR . self:: SITE_TEMPLATE_PATH . DR . self::TEMPLATE_DIR . DR . self::TEMPLATE_PARAMS_FILE;
    ...
    {
        $configDir = $_SERVER['DOCUMENT_ROOT'] . DR . self:: MAIN_DIR . DR . self::SITE_TEMPLATE_PATH . DR . self::TEMPLATE_DIR . DR . self::TEMPLATE_CONFIG_DIR;
    ...
    public static function getCurrentLang() {
        ...
        //return $_COOKIE["USER_LANG"] ? $_COOKIE["USER_LANG"] : self::$defaultLang;]
        return 'ru';
    }
    ...
    private static function findKey($key, $split, $arr) {
        ...
        while ( array_key_exists((string) current($keys), (array) $arr)) {
