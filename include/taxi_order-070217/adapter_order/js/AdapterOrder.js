...
AdapterOrder.prototype = Object.create(TaxiOrder.prototype);
AdapterOrder.prototype.constructor = AdapterOrder;


AdapterOrder.prototype.findTariffs = function (successCbk, errorCbk) {
  var self = this;
...
AdapterOrder.prototype.findGeoObjects = function (params, successCbk, errorCbk) {
  var self = this;
...
AdapterOrder.prototype.calcCost = function (params, successCbk, errorCbk) {
  var self = this;
  var method = {
    name: 'callCost',
    params: params
...
AdapterOrder.prototype.validateParams = function (formParams, successCbk, errorCbk) {
  var self = this;
  var params = {
    command: 'createOrder',
...
AdapterOrder.prototype.needSendSms = function (formPhone, successCbk, errorCbk) {
  var self = this;
  var formPhone = '8900';
  var method = {
    name: 'needSendSms',
...
AdapterOrder.prototype.sendSms = function(paramsPhone, successCbk, errorCbk) {
  var self = this;
...
AdapterOrder.prototype.createOrder = function (formParams, successCbk, errorCbk) {
  var self = this;
...
AdapterOrder.prototype.getOrderInfoInterval = function (params, successCbk, errorCbk) {
  var self = this;
...
AdapterOrder.prototype.getOrderInfo = function (orderId) {
  var self = this;
...
AdapterOrder.prototype.rejectOrder = function (orderParams, successCbk, errorCbk) {
  var self = this;
