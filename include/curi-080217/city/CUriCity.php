  ...
  protected function set_cookie()
{
	...
	if (!array_key_exists($ar_settings["cookie_var"], $_COOKIE) || $ar_element["code"] != $_COOKIE[$ar_settings["cookie_var"]]) {
		setcookie($ar_settings["cookie_var"], $ar_element["code"], time() + $this->_cookie_time, self::$_site_dir);
		setcookie('CITY_LAT', $ar_element["lat"], time() + $this->_cookie_time, $this->_site_dir);
		setcookie('CITY_LON', $ar_element["lon"], time() + $this->_cookie_time, $this->_site_dir);
		setcookie('CITY_GOOTAX_ID', $ar_element["idgootax"], time() + $this->_cookie_time, $this->_site_dir);
	}
}
